        ...
        <form class="layui-form">
            <div class="layui-form-item">
                <label class="layui-form-label">
                    <span class="x-red">*</span>补卡人</label>
                <div class="layui-input-inline">
                    <input type="text"  name="repairName" readonly value="${employee.empName}" autocomplete="off" class="layui-input">
                </div>

                <div class="layui-inline">
                    <label class="layui-form-label">补卡时间</label>
                    <div class="layui-input-inline">
                        <input type="text" name="repairDate" id="punchDate" <c:if test="${type=='edit'}">value="${punchCard.punchDate}"</c:if> autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">补卡原因</label>
                    <div class="layui-input-block">
                        <textarea name="repairReason" <c:if test="${type=='edit'}">readonly</c:if> class="layui-textarea" ><c:if test="${type=='edit'}">${punchCard.punchText}</c:if></textarea>
                    </div>
                </div>
                <c:if test="${type=='add'}">
                    <div class="layui-form-item">
            ...
            function(data) {
                if (<%=request.getAttribute("type").equals("add")%>){
                    $.ajax({
                        ...
                        url:'/repair/add',
                        data:{
                            repairNo:'<%=((Employee)request.getAttribute("employee")).getEmpNo()%>',
                            repairName:data.field.repairName,
